...
class PesenikManager:
    ...
    def getSong (self, author, song):
        if author == "aaa":
            return Song("Group1Song1", "Group1", author,   """"Group1Song1Text:
                    А я ёжиков люблю""" , song)
        elif author == "aab":
            return  Song("Group2Song1", "Group2", author,   """"Group2Song1Text:
                    В каморке, что за актовым залом...""" , song)
